			...
			while (inputLine != null
				...
				while (rodada > 0) {
					...
					if (posicao == 1) {
						...
						try {
							if (indice == 0 || indice == 2) {
								placar1.add(posicaoJogar, resultados1);
								out.println(placar1);
								sendMsg(out, " Jogando: \n", placar1.toString());
							} else {
								placar2.add(posicaoJogar, resultados2);
								out.println(placar2);
								sendMsg(out, " Jogando: \n", placar2.toString());
							}
