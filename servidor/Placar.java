...
public class Placar {
    ...
    /**
     * Construtor que seta um vetor de dez posições para ser o placar e o aloca com
    ...
    public void add(int posicao, int[] dados) throws java.lang.IllegalArgumentException {
        /*
         * Posição pode assumir valores entre 1 e 10, sendo os valores de um a seis
         * referentes a essas casas;
         * a 7, FullHand; 8, sequencia; 9, quadra; 10, quina (cof, cof, GENERAL)
         */
        if (posicao > 0 && posicao < 11) {
            switch (posicao) {
                /*
                 * De 1 a 6 o switch vê quantos dados mostram a face escolhida para cima e
                 * coloca a soma dos
                 * valores na 'posicao'
                 */
                case 1:
                    if (placar[0] != -1)
                        throw new IllegalArgumentException("Essa posição está ocupada.");
                    else {
                        int result = 0;
                        for (int i = 0; i < 5; i++) {
                            if (dados[i] == 1)
                ...
                /*
                 * Verifica a validade de um full hand, usando flags para quando há 3 números
                 * iguais,
                ...
                case 7: /* FULL HAND: 3 de um numero, 2 de outro ou 5 numeros iguais */
                    ...
                    break;
                /*
                 * Verifica a validade de uma sequência, alocando um vetor de 6 posições, cada
                 * qual com um
                 * contador de frequência na jogada. Se o contador for maior que 1 em alguma das
                 * casas, significa
                ...
                /*
                 * Verifica a validade de uma quadra, vendo se algum dos índices de frequência
                 * dos dados
                ...
                /*
                 * Verifica a validade de um general, vendo se algum dos índices de frequência
                 * dos dados
                 * é igual a 5
                 */
